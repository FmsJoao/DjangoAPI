...
from school.serializer import StudentSerializer, CourseSerializer, RegistrationSerializer, ListRegistrationsStudentSerializer, ListStudentInCourseSerializer
...
class ListRegistrationsStudent(generics.ListAPIView):
    """Listing a student or student's registrations"""
...
class ListStudentsRegistered(generics.ListAPIView):
    ...
    def get_queryset(self):
        ...
        return queryset
    serializer_class = ListStudentInCourseSerializer
    authentication_classes = [BasicAuthentication]
    permission_classes = [IsAuthenticated]
